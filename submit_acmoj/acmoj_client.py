...
# -*- coding: utf-8 -*-
"""
ACMOJ API Client Command Line Tool - Git Repository Submission Version v2.2

Usage Examples:
1. Submit Git repository URL:
   python3 acmoj_client.py --token ${ACMOJ_TOKEN} submit --problem-id ${ACMOJ_PROBLEM_ID} --git-url https://github.com/user/repo
...
def main():
    ...
    submit_parser = subparsers.add_parser("submit", help="Submit a Git repository URL")
